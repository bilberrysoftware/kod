...
**System and App information (REQUIRED):**

- OS exact version: [e.g. Ubuntu WSL x.y.z]
- kod app version: [e.g. Release ID (v0.2.0), latest develop branch, or commit ID]
- Have you reproduced this issue on the latest 'develop' kod branch?: [Yes, No]

Without the above information the kod team will be unable to reproduce 
...
- Likely How Widespread: [LOW = Less than 5% of installs of this variant, MEDIUM = 5%-50%, HIGH = More than 50%]
